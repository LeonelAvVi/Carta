-- Estado "closed": cuenta cobrada / mesa liberada (ya no cuenta para ocupación ni cuenta abierta)
...
comment on column public.orders.status is
  'pending → confirmed → preparing → ready → delivered; cancelled; closed = mesa/cuenta cerrada';

-- Analytics: pedidos cerrados también cuentan como venta cobrada
